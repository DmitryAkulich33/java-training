...
<head>
    ...
    <style>
        <%@include file="front/style/style.css" %>
        <%@include file="front/css/bootstrap.min.css" %>
    </style>
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.16.0/umd/popper.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js"></script>
    <script>
        <%@include file="front/js/bootstrap.js" %>
    </script>
    <title>Bakery</title>
</head>
<body>
<div class="container-fluid pt-3">
    <div class="p-3 m-3 bg-dark text-white">
        <table>
            <tr>
                <td class="logo" rowspan="2"><img class="image_logo" src="front/logo/logo1.png"></td>
                <td class="name_organization">T A S T Y P I E . C O M</td>
                <td class="a1_logo"><img class="image_logo_a1" src="front/logo/a1.png"></td>
                <td class="a1_phone">+375-44-564-61-30</td>
            </tr>
            <tr>
                <td class="address_organization">27 Lubimova St, Minsk</td>
                <td class="mts_logo"><img class="image_logo_a1" src="front/logo/mts.png"></td>
        ...
        <ul class="ul_pages">
            <li class="li_pages">
                <div class="button_navbar_menu">
                    <a href="bakery_about.html" class="a_link"><img src="front/logo/group.png" class="ico"> ABOUT US</a>
                </div>
            </li>
            <li class="li_pages">
                <div class="button_navbar_menu">
                    <a href="bakery_menu.html" class="a_link"><img src="front/logo/magazine.png" class="ico"> OUR
                        PIES</a>
                </div>
            </li>
            <li class="li_pages">
                <div class="button_navbar_menu">
                    <a href="bakery_contacts.html" class="a_link"><img src="front/logo/hours.png" class="ico"> CONTACTS</a>
                </div>
            </li>
            <li class="li_pages">
                <div class="button_navbar_menu">
                    <a href="bakery_delivery.html" class="a_link"><img src="front/logo/runner.png" class="ico"> DELIVERY</a>
                </div>
            </li>
            <li class="li_pages">
                <div class="button_navbar_menu">
                    <a href="bakery_feedback.html" class="a_link"><img src="front/logo/pen.png" class="ico">
                        FEEDBACK</a>
                </div>
            </li>
            <li class="li_pages">
                <div class="button_navbar_menu">
                        ...
                        <button type="button" class="in_basket_menu h5" data-toggle="modal" data-target="#myModal">
                            <a href="#" class="a_link"><img src="front/logo/basket.png" class="ico"> BASKET</a>
                        </button>
    ...
    <ul class="ul_pie">
        <li class="li_pie">
            <table class="table_pie">
                <tr>
                    <td class="product_width" rowspan="5"><img class="image_pie rounded" src="front/pies/Belarus.png">
                    </td>
...
<%--                            </button>--%>
        ...
        <li class="li_pie">
            <table class="table_pie">
                <tr>
                    <td class="product_width" rowspan="5"><img class="image_pie rounded" src="front/pies/Ital.png"></td>
        ...
        <li class="li_pie">
            <table class="table_pie">
                <tr>
                    <td class="product_width" rowspan="5"><img class="image_pie rounded" src="front/pies/Germ.jpg"></td>
        ...
        <li class="li_pie">
            <table class="table_pie">
                <tr>
                    <td class="product_width" rowspan="5"><img class="image_pie rounded" src="front/pies/france.png">
                    </td>
        ...
        <li class="li_pie">
            <table class="table_pie">
                <tr>
                    <td class="product_width" rowspan="5"><img class="image_pie rounded" src="front/pies/Belg.png"></td>
        ...
        <li class="li_pie">
            <table class="table_pie">
                <tr>
                    <td class="product_width" rowspan="5"><img class="image_pie rounded" src="front/pies/Goland.png">
                    </td>
        ...
        <li class="li_pie">
            <table class="table_pie">
                <tr>
                    <td class="product_width" rowspan="5"><img class="image_pie rounded" src="front/pies/grec2.png">
                    </td>
        ...
        <li class="li_pie">
            <table class="table_pie">
                <tr>
                    <td class="product_width" rowspan="5"><img class="image_pie rounded" src="front/pies/Irla.png"></td>
    ...
    <div class="container-fluid p-3 m-3 bg-dark text-white">
        <table>
            <td class="td_last_text">
                <img class="image_logo" src="front/logo/logo1.png">
            </td>
            <td class="td_last_text">
        <span>
