...
<div class="container-fluid">
                        ...
                        <div class="modal-body">
                            <form action="controller" method="POST">
                                ...
                                <div class="modal-footer">
                                    <input type="hidden" name="command" value="find_basket_product_by_user_id">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="controller" method="POST">
                                ...
                                <div class="modal-footer">
                                    <input type="hidden" name="command" value="find_basket_product_by_order_id">
                                    <input type="submit" value="Find products" class="btn btn-secondary">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                                </div>
                            </form>
    ...
    <table class="table table-hover">
        ...
        <%--                                        <input type="hidden" name="command" value="delete_basket_product">--%>
