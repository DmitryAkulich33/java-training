...
<div class="container-fluid">
    ...
    <div class="btn-group">
        <form action="controller" method="POST">
            ...
            <input type="submit" class="change-info btn btn-primary" value="<fmt:message key="pie"/>">
        </form>
        <form action="controller" method="POST">
        ...
        <form action="controller" method="POST">
            ...
            <input type="hidden" name="page" value="1">
            <input type="submit" class="change-info btn btn-primary" value="<fmt:message key="admin.feedback"/>">
        </form>
        <form action="controller" method="POST">
