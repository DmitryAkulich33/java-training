...
public class ShowFeedbackCommand implements Command {
    ...
    private static Logger log = LogManager.getLogger(ShowFeedbackCommand.class.getName());


    @Override
    public CommandResult execute(HttpServletRequest request, HttpServletResponse response) {
        log.debug("Loading feedbacks started.");
        ...
        log.debug("Loading feedbacks finished.");
