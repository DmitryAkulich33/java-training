...
public class MessageFilter implements Filter {
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        ...
        messagesEn.put("wrongAmount", "The number of pies is wrong!");
        messagesEn.put("rightAmount", "Product added to basket!");
        messagesEn.put("rightOrder", "The order was changed successfully!");
        messagesEn.put("rightPie", "The pie was changed successfully!");
        ...
        messagesEn.put("rightFeedback", "Your feedback has been successfully added!");
        ...
        messagesRu.put("wrongAmount", "Количество пирогов неверное!");
        messagesRu.put("rightAmount", "Товар добавлен в корзину!");
        messagesRu.put("rightOrder", "Заказ был изменен успешно!");
        messagesRu.put("rightPie", "Пирог был изменен успешно!");
        ...
        messagesRu.put("rightFeedback", "Ваш отзыв был добавлен успешно!");
        ...
        messagesBe.put("wrongAmount", "Колькасць пірагоў няправільнае!");
        messagesBe.put("rightAmount", "Тавар дададзены ў карзіну!");
        messagesBe.put("rightOrder", "Заказ быў зменены паспяхова!");
        messagesBe.put("rightPie", "Пірог быў зменены паспяхова!");
        ...
        messagesBe.put("rightFeedback", "Ваш водзыў быў дададзены паспяхова!");
