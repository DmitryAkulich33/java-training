...
VALUES
       (4, "2020-04-02T09:22:09", "I ordered two pies - Belorussian and Greek. They were delivered on time. I was surprised because it was very fast. The administrator is polite and attentive. I think that team of 'TastyPie' is professional. I will order their pies in future and will recommend this company to all of my friends."),
       (5, "2020-04-05T10:01:01", "I ordered Italian pie. It was not expensive. I think that pie costs its money, because it was delicious. All my family liked this pie and we  want to order more and more. I think we need to try every pie of this company."),
       (6, "2020-04-08T11:00:04", "I wanted to order pies to the office for my birthday party. I did it in the morning and I got my pies at lunchtime. They were hot and looked tasty. I liked Irish pie most of all, but my collegues liked Belgian and French. Irish pie was good for me, because I am a vegetarian and I like pumpkin very much. There was a lot of filling im the pies. My birhday party was excelent. 'TastyPie', thank you very much for your work. You are the best!"),
       (7, "2020-04-09T12:14:01", "It was delicious!"),
       (8, "2020-04-10T13:32:09", "I ordered sweet pies for my children several times – French, Deutsch, Greek. What they like most of all, is that there are a lot of berries inside. Their favorite is Deutsch pie with strawberries and ricotta."),
       (9, "2020-04-11T14:43:12", "If I do not have time to cook at home in advance, I order meals to the office. In TastyPie I prefer Belorussian one – it is with potatoes and mushrooms and can easily replace dinner. The delivery service works quickly – in an hour you will get a hot meal."),
       (10, "2020-04-12T15:55:32", "I was in the country with my family and did not want to spend the weekend near the cooker. In TastyPie it is possible to get several pies, even if you are far from Minsk. Prices for delivery are not so high."),
       (4, "2020-04-13T16:12:05", "It is often a problem to order dishes for holidays. That is why it is convenient to make pre-orders. You just choose menu and time of delivery and do not worry about queues. This way I ordered pies for March, 8 in the end of February."),
       (5, "2020-04-14T17:11:11", "It is excellent that you can pick up pies yourself. The office is near my house, so I do not want to pay for delivery. No matter one or five pies you order you can come and get them yourself and save money."),
       (6, "2020-04-15T18:04:05", "French pie is very tasty. It is with spicy cherry and hints of clove. I have never eaten a similar one in other places and advice everyone to try it!"),
       (7, "2020-04-16T19:15:02", "I ordered 3 pies for my Birthday and got not only delivery, but a discount as well. It is great when companies have loyalty policy for regular clients."),
       (8, "2020-04-17T20:00:01", "All the pies in the menu are always available to order. I do not like the situations when there are no necessary products on the kitchen at all and my plans are ruined. With TastyPie I have never had this problem.");
