...
("user2",   "user2",    3,  "Petrov", "Petr",	"Petrovich", "Apt 45, 17 Kazinca St, Minsk", "+375 44 5737640",	"There are enough parking spaces in the yard"),
("user3",   "user3",    3,  "Sidorov", "Sidr",	"Sidorovich", "Apt 95, 27 Lubimova St, Minsk", "+375 44 5982331", "Near the house there are construction work"),
("user4",   "user4",    3,  "Andreev", "Andrey", "Andreevich", "Apt 54, 24 Alibegova St, Minsk",  "+375 29 9653132", "There are enough parking spaces in the yard"),
...
VALUES
	...
	("Irish",		1000,	25.00,	"Signature dough, stewed carrots with pumpkin in soft cheese, with onions and celery", "image/Irla.png");
